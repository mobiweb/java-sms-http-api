/*
.---------------------------------------------------------------------------.
|  Software: 	SMS - Send SMS Example: Get SMS Account Balance Example		|
|  Version: 	3.10														|
...
public class SMS_example_balance {
    public static void main(String [ ] args){
        SMS sol4mob_sms         =   new SMS();                  			// Create SMS object.
        sol4mob_sms.send_url    =   "http://IPADDRESS/balance_script";   	// The HTTP request URL used for account balance information.
        ...
        String ret              =   sol4mob_sms.getBalance();   			// Call method getBalance() to get account
