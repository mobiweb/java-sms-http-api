/*
.---------------------------------------------------------------------------.
|  Software: 	SMS - Send SMS Example: Multiple Recipients SMS				|
|  Version: 	3.10														|
...
public class SMS_example_multiple_recipient_msg {
    public static void main(String [ ] args){
        ...
        sol4mob_sms.phone       =   "recipient1,recipient2";    		// The full International mobile number of the
                                                                    	// recipient excluding the leeding +. To send to
